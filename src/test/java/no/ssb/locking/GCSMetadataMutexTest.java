...
public class GCSMetadataMutexTest {
    ...
    static final String GCS_MUTEX_PATH = "testng/metamutex-" + (int) (100000 * Math.random()) + ".dat";
    ...
    public void thatTimeToLiveWorks() throws InterruptedException {
        GCSMetadataMutex mutex = GCSMetadataMutex.create(storage, blobId, Duration.ofMillis(10));
        assertTrue(mutex.tryLock());
        Thread.sleep(500);
